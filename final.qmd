...
tidy(happiness_gdp_lm) |> 
  kable()
```
The intercept value of 46.8 represents the expected happiness score when GDP per capita is 0. The slope of 0.000524 means that for every 1000 international dollar increase in GDP per capita the happiness score increases by about half a point.
